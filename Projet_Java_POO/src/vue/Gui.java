...
public class Gui extends Application {
	...
	public void start(Stage stage) {
		try {
	        ...
	        imageView7.setFitHeight(4); 
	        imageView7.setFitWidth(380); 
			...
			//style de 3 boutons en utilisant CSS
			clear = new Button("Clear");
			clear.setStyle("-fx-font: 15 arial; -fx-font-weight: bold; -fx-base: #C2FFF5;");

			keyboard = new Button("KeyBoard");
			keyboard.setStyle("-fx-font: 15 arial; -fx-font-weight: bold; -fx-base: #DB7093;");
...
//---------------------Getters et Setters pour tous les boutons-----------------------//
